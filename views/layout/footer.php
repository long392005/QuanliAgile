      ...
      <div class="row row-cols-lg-5 row-cols-2">
        ...
        <div class="footer-column footer-newsletter col-12 mb-4 mb-lg-0">
          ...
          <div class="mt-4 pt-3">
            ...
            <p class="mt-2">
              <img loading="lazy" src="./assets/images/payment-options.png" alt="Acceptable payment gateways">
            </p>
          </div>
        </div><!-- /.footer-column -->
      </div><!-- /.row-cols-5 -->
  ...
  <div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
    ...
    <div class="aside-content cart-drawer-items-list">
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="./product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="./assets/images/cart-item-1.jpg" alt="">
          </a>
        </div>
      ...
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="./product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="./assets/images/cart-item-2.jpg" alt="">
          </a>
        </div>
        <div class="cart-drawer-item__info flex-grow-1">
      ...
      <div class="cart-drawer-item d-flex position-relative">
        <div class="position-relative">
          <a href="./product1_simple.html">
            <img loading="lazy" class="cart-drawer-item__img" src="./assets/images/cart-item-3.jpg" alt="">
          </a>
        </div>
        <div class="cart-drawer-item__info flex-grow-1">
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="sitemap d-flex">
        <div class="w-50 d-none d-lg-block">
          <img loading="lazy" src="./assets/images/nav-bg.jpg" alt="Site map" class="sitemap__bg">
              ...
              <div class="swiper-container js-swiper-slider"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="./assets/images/products/quickview_1.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="./assets/images/products/quickview_2.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="./assets/images/products/quickview_3.jpg" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="./assets/images/products/quickview_4.jpg" alt="">
                  </div>
                </div>
